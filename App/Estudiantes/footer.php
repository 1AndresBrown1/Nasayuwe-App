...
<div class="drawer-side">
    ...
    <div class="menu p-4 w-64 max-w-full min-h-full bg-base-200 text-base-content">
        ...
        <img class="w-auto h-16 sm:h-16 mt-5" src="./img/logos/estudiante.png" alt="">
        </a>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav class="">
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="cursos_estudiantes">
               ...
               <!-- <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="evaluaciones_estudiantes">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
