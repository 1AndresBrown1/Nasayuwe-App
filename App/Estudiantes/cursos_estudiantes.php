...
<div class="flex flex-col lg:flex-row h-screen">
    ...
    <div class="w-full h-full lg:w-1/2 bg-base-100 hover:bg-gray-900 hover:text-white  ease-linear	duration-300">
        <a href="videos_estudiantes_alf">
            <div class="w-full bg-center bg-cover h-full">
                <div class="flex items-center justify-center w-full h-full">
                    <div class="text-center">
                        <center>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-12 mb-3 ">
            ...
            <div class="w-full bg-center bg-cover h-full">
                <div class="flex items-center justify-center w-full h-full">
                    <div class="text-center">
                        ...
                        <h1 class="text-3xl font-semibold  lg:text-4xl hover:text-5xl ease-linear duration-150">Computacional</span> </h1>
                        <center>
                            <a href="videos_estudiantes">
                                <button class="mt-4 flex items-center px-4 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
...
<div class="fixed bottom-0 bg-base-300 right-0 m-4 w-80 max-w-sm overflow-hidden rounded-lg shadow-md sm:bottom-auto sm:top-0 sm:right-0">
    <div class="flex">
        ...
        <div class="px-4 py-2 -mx-3">
            <div class="mx-3">
                <span class="font-semibold">¿QUÉ CURSO DESEAS AGREGAR?
                </span>
                <p class="text-lg">
