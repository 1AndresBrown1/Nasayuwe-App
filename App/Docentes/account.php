    ...
    <nav class="bg-white border-b border-gray-200">
        <div class="container mx-auto flex items-center justify-between p-4">
            <div class="flex items-center space-x-4">
                <a href="evaluaciones?q=0" class="text-xl font-semibold <?php echo @$_GET['q'] == 1 ? 'text-blue-500' : 'text-gray-700'; ?>">Inicio</a>
                <a href="evaluaciones?q=2" class="text-xl font-semibold <?php echo @$_GET['q'] == 3 ? 'text-blue-500' : 'text-gray-700'; ?>">Calificaciones</a>
            </div>
    ...
    <div class="container mx-auto mt-6">
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <?php if (@$_GET['q'] == 1) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    if ($rowcount == 0) {
                        ...
                        <td class="px-6 py-4 whitespace-nowrap"><a href="account?q=quiz&step=2&eid=' . $eid . '&n=1&t=' . $total . '" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700">Examen</a></td>
                        </tr>';
                    } else {
            ...
            if (@$_GET['q'] == 'quiz' && @$_GET['step'] == 2) {
                ...
                echo '<form action="update?q=quiz&step=2&eid=' . $eid . '&n=' . $sn . '&t=' . $total . '&qid=' . $qid . '" method="POST"  class="form-horizontal mt-4">';
                while ($row = mysqli_fetch_array($q)) {
                    $option = $row['option'];
