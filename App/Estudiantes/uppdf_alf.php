...
$sel = $conn->query("SELECT * FROM files_alf WHERE vid >= $currentVideoId AND documento_identidad = " . $_SESSION['identificacion']);
...
<div class="container mx-auto mt-20 sm:mt-6">
    <div class="mx-auto w-9/12 flex flex-col justify-center">
        ...
        <?php else: ?>
            <form action="upload_alf" method="post" enctype="multipart/form-data">
