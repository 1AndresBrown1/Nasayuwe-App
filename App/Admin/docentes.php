...
<div class="container p-4 mt-20 sm:mt-6">
    ...
    <h1 class="text-3xl mb-10 font-bold">Registro docentes</h1>
    ...
    <div role="tablist" class="tabs tabs-lifted">
        ...
        <div role="tabpanel" class="tab-content bg-base-100 border-base-300 rounded-box p-6">
            ...
            <form action="procesar_registro_docente" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 p-4">
                            <div>
                                ...
                                <div class="relative flex items-center mt-2">
                                    ...
                                    <input id="email" name="email" type="email" placeholder="Correo@gmail.com" class="block w-full py-2.5 border rounded-lg pl-11 pr-5 rtl:pr-11 rtl:pl-5 focus:border-blue-400 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40">
                                </div>
                            </div>
                ...
                <button type="submit" class="btn mt-4">Agregar Docente</button>
            </form>
        ...
        <input
            ...
            class="tab"
            aria-label="Editar" />
        <div role="tabpanel" class="tab-content max bg-base-100 border-base-300 rounded-box p-6">

            <div class="overflow-x-auto max-w-full">
                <table class="min-w-full">
                    <thead>
                        <tr class="w-full text-left border-b">
                            <th scope="col" class="px-4 py-2">#</th>
                            <th scope="col" class="px-4 py-2">Nombre</th>
                            <th scope="col" class="px-4 py-2">Apellido</th>
                            <th scope="col" class="px-4 py-2">Tipo de Documento</th>
                            <th scope="col" class="px-4 py-2">Documento de Identidad</th>
                            ...
                            <th scope="col" class="px-4 py-2">Fecha de Nacimiento</th>
                    ...
                    <tbody>
                        ...
                        if ($result && $result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<th scope='row' class='px-4 py-2'>$i</th>";
                                echo "<td class='px-4 py-2'>" . $row['nombre'] . "</td>";
                                echo "<td class='px-4 py-2'>" . $row['apellido'] . "</td>";
                                echo "<td class='px-4 py-2'>" . $row['tipo_documento'] . "</td>";
                                echo "<td class='px-4 py-2'>" . $row['documento_identidad'] . "</td>";
                                echo "<td class='px-4 py-2'>" . $row['telefono'] . "</td>";
                                echo "<td class='px-4 py-2'>" . $row['titulo'] . "</td>";
                                echo "<td class='px-4 py-2'>" . $row['email'] . "</td>";
                                echo "<td class='px-4 py-2'>" . $row['fecha_nacimiento'] . "</td>";
                                echo "<td class='px-4 py-2'>" . $row['estado'] . "</td>";

                                echo "<td class='px-4 py-2'>
                        <a class='text-blue-600 hover:text-blue-900' href='editar_docente?documento_identidad=" . $row['documento_identidad'] . "'>Editar</a> 
                    </td>";
                                echo "</tr>";
                                $i++;
                            }
                            ...
                            echo '<tr><td colspan="11" class="text-center py-4">No hay datos de docentes disponibles.</td></tr>';
                        }
                        ?>
                    </tbody>
                </table>
